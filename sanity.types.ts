...
// Variable: percentageDiscountsQuery
// Query: *[_type == "settings"][0].percentageDiscounts.styles[].modifier
export type PercentageDiscountsQueryResult = Array<number | null> | null
