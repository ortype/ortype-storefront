...
import { client } from 'lib/sanity.client' // from '@/sanity/lib/client'
import {
...
export function loadFont(slug: string) {
  return loadQuery<FontPagePayload | null>(
    fontAndMoreFontsQuery,
    { slug },
    { next: { tags: [`font:${slug}`] } }
  )
