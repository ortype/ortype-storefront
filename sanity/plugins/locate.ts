...
import { resolveHref } from 'lib/sanity.utils' // '@/sanity/lib/utils'
          ...
          case 'font':
            return {
              ...
              message: isReferencedBySettings
                ? 'The top menu is linking to this font'
                : "The top menu isn't linking to this font. It can still be accessed if the visitor knows the URL.",
            } satisfies DocumentLocationsState
          case 'page':
            return {
              locations: docs
