...
export const StyledGiftCardOrCouponRemoveButton = styled(
  ...
  ${tw`ml-2 text-sm font-bold text-base border-b leading-none border-black border-opacity-10 md: transition ease-in duration-200 hover:border-opacity-50 hover:text-base focus:outline-none`}
`
