...
export async function getFonts() {
  ...
  for (const fontFilePath of getFontFilePaths()) {
    ...
    if (font.familyName.toLowerCase().includes('italic')) {
      errors.push([
        'PANIC FORBIDDEN familyName ITALIC:',
        font.familyName,
        fontFilePath,
      ])
    }
    if (font.familyName.toLowerCase().includes('bold')) {
      errors.push([
        'PANIC FORBIDDEN familyName BOLD:',
        font.familyName,
        fontFilePath,
      ])
    }
    if (font.familyName.toLowerCase().includes('regular')) {
      errors.push([
        'PANIC FORBIDDEN familyName REGULAR:',
        font.familyName,
        fontFilePath,
      ])
    }
    if (font.familyName.toLowerCase().includes('var')) {
      errors.push([
        'PANIC FORBIDDEN familyName VAAAR:',
        font.familyName,
        fontFilePath,
      ])
    }
