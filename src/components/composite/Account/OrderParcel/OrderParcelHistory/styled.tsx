...
export const ShipmentDateChip = styled.div`
  ${tw`inline text-sm text-center text-gray-600 bg-gray-300 capitalize text-sm w-auto uppercase font-bold py-[2px] px-[12px] leading-snug rounded-xl align-middle`}
`
