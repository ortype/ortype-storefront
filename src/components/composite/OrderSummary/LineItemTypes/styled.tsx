...
export const StyledLineItemSkuCode = styled(LineItemCode)`
  ${tw`text-xs uppercase text-gray-400 font-bold mb-1`}
`
export const StyledLineItemOptions = styled(LineItemOptions)`
  h6 {
    ${tw`font-bold text-xs text-gray-600 mt-2 bg-no-repeat pl-5`}
  ...
  li {
    ${tw`text-gray-400 text-xs flex font-medium capitalize pl-5 pt-1 bg-no-repeat`}
    span {
      ${tw`font-bold text-gray-500 ml-1`}
    }
